...
public class Swagger {
	...
	public Docket detalheApi() {
		...
		docket.globalOperationParameters(params).select()
			.apis(RequestHandlerSelectors.basePackage("org.proj.residencia"))
	...
	private ApiInfoBuilder informacoesApi(){	
		...
		apiInfoBuilder.title("Residencia - API");
		apiInfoBuilder.description("API Residencia");
		apiInfoBuilder.version("1.0");
		apiInfoBuilder.termsOfServiceUrl("Termos de uso: Residência");
		apiInfoBuilder.license("Licença - Projeto Residência");
